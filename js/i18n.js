...
const translations = {
    ko: {
        ...
        'modal.edit.link3': '링크 3 - 로컬 폴더 (선택사항)',
        'modal.edit.color': '노드 색상',
        'modal.edit.borderColor': '테두리 색상',
        'modal.edit.borderWidth': '테두리 두께',
    ...
    en: {
        ...
        'modal.edit.link3': 'Link 3 - Local Folder (Optional)',
        'modal.edit.color': 'Node Color',
        'modal.edit.borderColor': 'Border Color',
        'modal.edit.borderWidth': 'Border Width',
